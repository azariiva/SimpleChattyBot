...
public class SimpleBot {
    ...
    static void test() {
        ...
        String[] answerStrings = {"To repeat a statement multiple times.",
        ...
        int correctAnswer = 2;
        String answerFormatString = "%d. %s";

        System.out.println(question);
        for (int i = 0; i < answerStrings.length; i++) {
            System.out.println(String.format(answerFormatString, i + 1, answerStrings[i]));
        }
        while (true) {
